...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\my_project\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\my_project\hook\ament_prefix_path.bat"
